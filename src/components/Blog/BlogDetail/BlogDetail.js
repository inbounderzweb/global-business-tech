                ...
                <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_360px] items-start">
                    ...
                    <article className="min-w-0 rounded-2xl bg-[#E7EEF6] p-6 md:p-8 ring-1 ring-slate-200/60">
                        ...
                        <p className="mt-5 text-sm leading-6 text-slate-600">
                            Corporate Boardrooms are no longer just an image building tool for large multi-national
                            organisations. Over the last decade they have evolved into the hub for most strategic,
                            operational and tactical decision making within organisations and are powered by a whole
                            new generation of tools for presentations and smooth sharing of content.
                        </p>

                        <p className="mt-4 text-sm leading-6 text-slate-600">
                            The modern boardroom &amp; conference room design features high-resolution displays of up
                            to 4K for improved image clarity resulting in crisper more engaging presentations. This
                            means that communicating finer details like intricate graphs, detailed spreadsheets and
                            high-definition photographs etc., is simpler than ever before. These displays can also be
                            touch sensitive, which allows information to be annotated to convey ideas in a more dynamic
                            and precise way.
                        </p>
                        ...
                        <p className="mt-4 text-sm leading-6 text-slate-600">
                            ...
                            to 4K for improved image clarity resulting in crisper more engaging presentations. This
                            means that communicating finer details like intricate graphs, detailed spreadsheets and
                            high-definition photographs etc., is simpler than ever before.
                        </p>
