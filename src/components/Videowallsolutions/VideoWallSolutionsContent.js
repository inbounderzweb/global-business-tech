                ...
                <div className="grid gap-8 lg:grid-cols-2 items-start">
                    ...
                    <div className="min-w-0">
                        <p className="text-sm leading-6 text-slate-600">
                            Global Business Tech complete portfolio of industry-leading video wall solutions
                            encompasses a wide range of different technologies, sizes, and resolutions. Our LED and
                            LCD solutions feature seamless, ultra-fine pitch direct view LED video walls or the
                            narrowest LCD bezels with the slimmest installation depths. Our LED-illuminated rear
                            -projection video wall displays deliver the superb image quality and industry-leading
                            power-efficient performance. All of our video walls deliver superior visual performance
                            with 24×7 reliability.
                        </p>

                        <p className="mt-4 text-sm leading-6 text-slate-600">
                            Global Business Tech innovative LED, LCD, and LED-illuminated rear-projection video wall
                            solutions are specifically designed to deliver precise and brilliant visual messages in
                            the world’s most demanding environments—from control rooms to digital signage and
                    ...
                    <div className="bg-[#EEF3F9] py-10 md:py-14">
                        <div className="mx-auto w-[98%] lg:w-[90%] max-w-6xl px-4 md:px-6 lg:pr-10">
                            ...
                            <p className="mt-4 text-sm leading-6 text-slate-600 max-w-xl">
                                Global Business Tech innovative LED, LCD, and LED-illuminated rear-projection video
                                wall solutions are specifically designed to deliver precise and brilliant visual
                                messages in the world’s most demanding environments—from control rooms to digital
