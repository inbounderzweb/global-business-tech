// src/components/productdetail/ProductDetailClient.js
'use client';
...
export default function ProductDetailClient({ product, breadcrumbItems }) {
            ...
            <div className="py-12 md:py-20">
                <div className="mx-auto w-full max-w-[1400px] px-4 md:px-8">
                    ...
                    {product.faqs && product.faqs.length > 0 && (
                        <div className="mt-16 bg-white rounded-[40px] p-10 shadow-sm">
                            <h2 className="text-2xl font-black text-[#2E6EA5] mb-8">Frequently Asked Questions</h2>
                            <div className="space-y-6">
